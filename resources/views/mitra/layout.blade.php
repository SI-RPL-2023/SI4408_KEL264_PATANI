...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item ">
                <a class="nav-link text-white {{ Request::routeIs('mitraArticles.index') ? 'active bg-gradient-success' : '' }}" href="{{route('mitraArticles.index')}}">
            ...
            <li class="nav-item ">
                <a class="nav-link text-white {{ Request::routeIs('mitraWorkshops.index') ? 'active bg-gradient-success' : '' }}" href="{{route('mitraWorkshops.index')}}">
