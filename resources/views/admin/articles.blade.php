...
@section('content')
                        ...
                        <form action="{{ route('articles.search') }}" method="post">
                            ...
                            <div class="col-lg-9 mt-lg-n2 mt-2">
                                ...
                                <div class="input-group input-group-static">
                                    ...
                                    <input class="form-control " placeholder="Please select date" name="search"
                                        type="text">
                                </div>
                            </div>
                                    ...
                                    <div class="card mt-5 mt-md-0">
                                        <div class="card-header p-0 mx-3 mt-n4 position-relative z-index-2">
                                            <a class="d-block blur-shadow-image">
                                                <img src="{{ asset('images/' . $article->image) }}" alt="img-blur-shadow"
                                        ...
                                        <div class="card-body pt-3">
                                            ...
                                            <p
                                                ...
                                                <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                                    data-bs-target="#detailModal{{ $article->id }}">
                                                    Lihat Detail
                                                </button>
                                        </div>
                                    </div>
    ...
    @foreach ($articles as $article)
        ...
        <div class="modal fade" id="detailModal{{ $article->id }}" tabindex="-1" aria-labelledby="detailModalLabel"
            aria-hidden="true">
